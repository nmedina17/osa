...
The study site was a regrowing 20 ha timber plantation of *Bombacompsis quinata* abandoned in ~1990 after the vulnerably dry-adapted species from the Guanacaste region *[@perezcordero02; @hulshof20]* grew poorly in very wet conditions.
...
Traits including successional stage (early, late) and main dispersal mode (wind, animal, water) were matched to species with *@werden20* data, and wood tissue carbon matched to genera with the GLOWCAD database *[@doraisami22]* given high alignment at species levels *[@chave06]*.
...
All trees censused were included in each analysis, including unidentified taxa, which were grouped together for community analyses and did not affect results.

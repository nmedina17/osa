...
```{r map, fig.width=4, fig.height=4, fig.cap="Map of conservation areas and study site on Osa Peninsula, Costa Rica. Map image data © 2022 Osa Conservation. Photo credit: Nicholas Medina."}
...
**Trait matching with *[@doraisami22]* **
...
Data and code were organized with R packages *here* *[@here]*, *bookdown* *[@bookdown2022]*, and *grateful* *[@grateful]*, and are stored at [nmedina17.github.com/osa](nmedina17.github.com/osa).

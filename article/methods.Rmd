...
```{r map, fig.width=4.5, fig.height=4.5, fig.cap="Map of (a) conservation areas and (b) study site (c) showing plot design among distance strata, and focal plantation timber taxon (c) Bombacopsis quinata on Osa Peninsula, Costa Rica. Map image data © 2009 Google, © 2022 Osa Conservation. Photo credit: Nicholas Medina."}

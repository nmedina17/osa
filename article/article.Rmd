...
To realize this potential, it is fundamental that we better understand how general ecological processes manifest under widespread conservation contexts.

At local scales, regeneration is strongly affected by landscape [ecological] heterogeneity as well as management history.

Most tropical forests are secondary (FAO 2020), meaning that forest regeneration is widespread.

However, patterns of forest regeneration remain unclear, especially at more local scales (\< \~50 ha).

Still, forests provide key functions like wood, carbon storage, and biodiversity maintenance.

Therefore, better understanding forest regeneration is an integral part of achieving more sustainable development.

Some general patterns of forest regeneration have emerged, but this also includes the lack of pattern in some cases.

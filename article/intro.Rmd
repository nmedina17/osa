...
Understanding secondary forest regeneration is key for global biodiversity conservation at the global scale, 
**yet local management remains the strongest driver of tropical forest carbon stores *[@pyles22]*.**

Secondary forest regeneration is often affected by edge effects, or changes near an ecosystem boundary, especially in heterogeneously-managed landscapes *[@perfecto09; @melo13]*.
...
Properties of the existing tree community also depend on land-use history and previous management *[@omeja12]*, together with the composition of surrounding forests.
...
More specifically, timber plantations have historically favored tree taxa that tend to be pioneering, or be faster-growing, have lower wood densities, and be less shade-tolerant *[@tabarelli08]*.
This could lead to a longer-term dominance of pioneer taxa, referred to as arrested succession *[@]*.
...
Additionally, the leftover timber stands could provide additional shade, which would not be available in a clear-cut harvested timber plantation, and this could help more shade-tolerant taxa establish and recruit better.
...
Overall, edge effects near degraded habitat edges are often negative, but influences from meta-population *[@levins79]* and meta-community *[@leibold04; @warren15]* theories do highlight dispersal as a key process for offsetting extinction debt and thus maintaining biodiversity, thereby potentially making particular edge effects, specifically from adjacent intact forests, actually beneficial for regeneration plantation forest parcels.
Taken together, these ideas suggest that near primary forest, shade-tolerant dispersal may facilitate plantation forest regeneration.
This kind of edge effect may ultimately help explain relatively high biodiversity compared to adjacent stands that can be found in agroforests *[@oliveira-neto17]*, forests affected by logging *[@clark12; @edwards14]*, and timber plantations *[@pryde15]*.

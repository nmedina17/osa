...
- Regeneration dynamics (e.g. associated biodiversity) should be better understood
...
- Away from forest edge--
    ...
    - Biomass of taxa often found in both successional stages increased then decreased
